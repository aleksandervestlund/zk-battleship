...
template BoardSetup() {
    signal input privShipX[51];
    signal input privShipY[51];
    ...
    ship5.X[0] <== privShipX[49];
    ship5.Y[0] <== privShipY[49];
    ship5.X[1] <== privShipX[50];
    ship5.Y[1] <== privShipY[50];
