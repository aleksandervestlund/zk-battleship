...
template BoardSetup() {
    signal input privShipX[41];
    signal input privShipY[41];
    ...
    ship4.X[0] <== privShipX[39];
    ship4.Y[0] <== privShipY[39];
    ship4.X[1] <== privShipX[40];
    ship4.Y[1] <== privShipY[40];
