...
template BoardSetup() {
    signal input privShipX[21];
    signal input privShipY[21];
    ...
    ship2.X[0] <== privShipX[19];
    ship2.Y[0] <== privShipY[19];
    ship2.X[1] <== privShipX[20];
    ship2.Y[1] <== privShipY[20];
