...
template BoardSetup() {
    signal input privShipX[61];
    signal input privShipY[61];
    ...
    ship6.X[0] <== privShipX[59];
    ship6.Y[0] <== privShipY[59];
    ship6.X[1] <== privShipX[60];
    ship6.Y[1] <== privShipY[60];
