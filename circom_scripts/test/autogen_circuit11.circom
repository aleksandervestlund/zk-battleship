...
template BoardSetup() {
    signal input privShipX[11];
    signal input privShipY[11];
    ...
    ship1.X[0] <== privShipX[9];
    ship1.Y[0] <== privShipY[9];
    ship1.X[1] <== privShipX[10];
    ship1.Y[1] <== privShipY[10];
