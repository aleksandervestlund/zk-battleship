...
template BoardSetup() {
    signal input privShipX[7];
    signal input privShipY[7];
    ...
    ship1.X[0] <== privShipX[2];
    ship1.Y[0] <== privShipY[2];
    ship1.X[1] <== privShipX[3];
    ship1.Y[1] <== privShipY[3];

    component ship2 = ValidShip(3);
    ship2.X[0] <== privShipX[4];
    ship2.Y[0] <== privShipY[4];
    ship2.X[1] <== privShipX[5];
    ship2.Y[1] <== privShipY[5];
    ship2.X[2] <== privShipX[6];
    ship2.Y[2] <== privShipY[6];
