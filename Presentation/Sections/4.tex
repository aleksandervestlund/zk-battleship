...
\begin{frame}{Circom $\rightarrow \pcalgostyle{Groth16}$ Pipeline}
    \begin{figure}
        \centering
...
\begin{frame}[fragile]{Circuit 2: Proving the Attack}
    \begin{columns}<1->
        ...
        \begin{itemize}
            ...
            \item \defn{Public inputs:} Player's guess, opponent board commitment, reported result $y \in \set{\hit, \miss}$.
