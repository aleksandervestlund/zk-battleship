...
template BoardSetup() {
    signal input privShipX[31];
    signal input privShipY[31];
    ...
    component ship3 = ValidShip(2);
    ship3.X[0] <== privShipX[29];
    ship3.Y[0] <== privShipY[29];
    ship3.X[1] <== privShipX[30];
    ship3.Y[1] <== privShipY[30];
